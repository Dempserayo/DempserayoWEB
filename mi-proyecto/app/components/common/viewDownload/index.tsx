            ...
            <section className="w-full max-w-7xl flex flex-col gap-4">
                ...
                <div className="w-full flex items-center group gap-2">
                    ...
                    <button 
                        ...
                        className="bg-slate-800/50 text-slate-500 border border-slate-500 hover:border-rose-500 hover:bg-rose-200/50 hover:text-rose-500  w-20 h-20 flex justify-center items-center transition-all duration-500 group cursor-pointer" 
